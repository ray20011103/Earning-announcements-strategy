    ...
    for i, date in enumerate(trading_dates):
        ...
        for pos in holdings:
            if (i - pos['buy_idx']) >= holding_days:
                ...
                if pd.isna(sell_price): sell_price = pos['buy_price'] # Safety
...
def run_robustness_suite():
    ...
    for days in [20, 40, 60, 80]: # Reduced range for speed
    ...
    plt.savefig('analysis_results/plots/robustness_v2.png')
    print("Robustness Report saved: analysis_results/plots/robustness_v2.png")
